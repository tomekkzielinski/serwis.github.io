...
--
-- Host: localhost:3306
-- Czas generowania: 06 Sty 2023, 16:18
...
('root', '[{\"db\":\"serwis\",\"table\":\"visits\"},{\"db\":\"serwis\",\"table\":\"wizyty\"},{\"db\":\"serwis\",\"table\":\"Wizyty\"}]');
...
('root', 'serwis', 'visits', '{\"CREATE_TIME\":\"2022-12-27 21:09:07\",\"col_order\":[1,2,3,4,0],\"col_visib\":[1,1,1,1,1]}', '2022-12-29 14:55:31');
...
('root', '2023-01-06 15:18:31', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pl\"}');
...
-- Baza danych: `serwis`
--
CREATE DATABASE IF NOT EXISTS `serwis` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `serwis`;
...
(1, 14, '2023-01-12', 'test test', 111111111, 'test@test.pl', 'opony'),
(2, 18, '2023-01-20', 'testp testp', 111111111, 't.zielinski5@best.net.pl', 'klocki hamulcowe');
